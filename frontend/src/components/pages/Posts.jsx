...
const TimestampComponent = ({ timestamp }) => {
  ...
  return (
    <>
      ...
      {moment(currDate).format("hh:mm a")}
    </>
  );
};
      ...
      <div className="mt-4">
        {postState.loading || postState.posts === null ? (
          ...
          <p className="text-center lead">
            Sorry!! Not found any posts at this moment. You can add new post
            here!
          </p>
        ) : (
                ...
                >
                  ...
                  <div style={{ flex: 1.5 }} className="ml-5">
                    ...
                    <small className="text-muted">
                      Posted on{" "}
                      <TimestampComponent timestamp={post.created_at} />
                    </small>
