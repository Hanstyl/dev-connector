      ...
      <form style={{ fontSize: "14px" }} onSubmit={submitHandler}>
        ...
        <div className="mb-3">
          ...
          <StyledInput
            ...
            onChange={onChange}
            className={`form-control ${
              wrongUserInput.email ? "wrong_input" : ""
            }`}
        ...
        <div className="mb-3">
          ...
          <StyledInput
            ...
            onChange={onChange}
            className={`form-control ${
              wrongUserInput.password ? "wrong_input" : ""
            }`}
          />
          {wrongUserInput.password ? (
            <StyledInputErrorMessage>
              Please use a password with minimum 8 characters. Contains at least
              1 symbol, 1 uppercase, 1 number, 1 lowercase{" "}
            </StyledInputErrorMessage>
          ) : (
            <></>
          )}
