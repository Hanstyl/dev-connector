              ...
              <div className="py-3 list-group-item d-flex align-items-center justify-content-evenly">
                ...
                <div style={{ flex: 1.5 }} className="ml-5">
                  ...
                  <small className="text-muted">
                    Posted on{" "}
                    <TimestampComponent timestamp={currentPost.created_at} />
                  </small>
                  <div style={{ marginTop: "12px" }}>
                    ...
                    >
                      <i
                        className={`${
                          currentPost.reaction === 1 ? "fas" : "far"
                        } fa-thumbs-up`}
                      ></i>
                    </button>
                    <button
                    ...
                    >
                      <i
                        className={`${
                          currentPost.reaction === 0 ? "fas" : "far"
                        } fa-thumbs-down`}
                      ></i>
                    </button>
                    <button
            ...
            <div className="list-group">
              {!comments || (comments && comments.length === 0) ? (
                <p className="text-center lead">
                  This post didn't have any comments yet. You can add new
                  comment here!
                </p>
              ) : (
                comments &&
                comments.map((comment) => (
                  ...
                  >
                    ...
                    <div style={{ flex: 1.5 }} className="ml-5">
                      ...
                      <small className="text-muted">
                        Posted on{" "}
                        <TimestampComponent timestamp={comment.created_at} />{" "}
                      </small>
                      <>
                        <style type="text/css">
                          {`
                        ...
                        <div className="delete_btn_container">
                          {comment.author_id === user.id ? (
                            <button
                              ...
                              disabled={
                                comment.deleting || currentPost.deleting
                              }
                              style={{ fontSize: "13px" }}
                              className="btn btn-sm btn-danger"
                            >
